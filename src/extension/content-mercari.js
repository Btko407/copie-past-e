...
(function () {
  ...
  window.addEventListener('message', (event) => {
    ...
    // Normalise mecari/mercari drift inside the payload's platformFields
    if (payload.platformFields && payload.platformFields.mecari && !payload.platformFields.mercari) {
      payload.platformFields.mercari = payload.platformFields.mecari;
    }
  ...
  console.log('[CopiePaste:mercari] Content script v1.4.0 loaded. Awaiting TRIGGER_AUTOFILL / COPIE_AUTOFILL.');
})();
