...
export function ClockAnimation({ active }: ClockAnimationProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-6">
        ...
        >
          <div className="w-48 h-48 rounded-full border-4 border-primary/30 glow-blue absolute inset-0" />
          <div
        ...
        {/* Clock face — positioned over ring */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          >
            <title>Clock face animation</title>
            <circle
              cx="70"
              cy="70"
              r="65"
            ...
            <circle cx="70" cy="70" r="5" fill="oklch(0.88 0.19 84)" />
            <circle cx="70" cy="70" r="3" fill="oklch(0.08 0 0)" />
          </svg>
        </div>
