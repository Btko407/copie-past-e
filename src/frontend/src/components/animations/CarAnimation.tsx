...
export function CarAnimation({ active }: CarAnimationProps) {
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(to right, transparent, oklch(0.65 0.22 262 / 0.3))",
            filter: "blur(8px)",
          }}
        />

        {/* DeLorean-style car SVG */}
        <svg
          width="320"
          height="120"
          viewBox="0 0 320 120"
          ...
          style={{
            filter:
              "drop-shadow(0 0 16px oklch(0.65 0.22 262)) drop-shadow(0 0 32px oklch(0.88 0.19 84 / 0.5))",
          }}
        >
          <title>Time-traveling car</title>
          {/* Body */}
          <path
          ...
          />
          {/* Headlight */}
          <ellipse cx="300" cy="65" rx="8" ry="5" fill="oklch(0.88 0.19 84)" />
          {/* Exhaust glow */}
          <ellipse
            cx="18"
            cy="78"
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(to left, oklch(0.88 0.19 84 / 0.9), transparent)",
              filter: "blur(4px)",
      ...
      {/* Road line */}
      <div className="absolute bottom-[35%] left-0 right-0 h-px bg-primary/20" />
    </motion.div>
  );
}
