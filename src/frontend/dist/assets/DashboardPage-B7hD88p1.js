import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, X, u as useNavigate, L as ListingStatus, m as motion, S as Skeleton, C as Copy, R as RefreshCw, B as Button, a as ue, b as useActor, d as useQueryClient, e as useMutation, f as createActor, g as CircleCheck, h as useAuth, i as useQuery, Z as Zap, k as useDevice, T as TriangleAlert, l as useExtensionStatus, P as Platform__1, n as Platform__2, I as ItemCondition, o as useCheckLowFuelNotification, p as Layout, M as MaintenanceBanner, q as Input } from "./index-DlPcOTZa.js";
import { c as copyText, u as useListingImages, a as useArchiveListing, b as useRestoreListing, d as usePermanentDeleteListing, e as useTogglePin, f as useToggleFavorite, P as Pencil, g as useListings, h as useFavoritedListings } from "./copyText-Bm5NIvxj.js";
import { u as useGetMySubscription, a as useGetTiers } from "./useTiers-aieU94yL.js";
import { C as Check } from "./check-Dnn7GRhq.js";
import { A as Archive } from "./archive-C_DjVTon.js";
import { L as LoaderCircle } from "./loader-circle-BDsI1hNs.js";
import { T as Trash2 } from "./trash-2-CC-jY3rN.js";
import { P as Plus } from "./plus-D7lSAI_U.js";
import { u as usePhotoOCR } from "./usePhotoOCR-DweIGwAZ.js";
import { U as Upload } from "./upload-BDnfcrMR.js";
import { T as Tag } from "./tag-B1xrrqtL.js";
import { E as ExternalLink } from "./external-link-Dp8cy3Hz.js";
import { u as useGetPaymentBanner, a as useDismissPaymentBanner, b as useCreateStripePortalSession } from "./useStripePayments-D18miN7o.js";
import { A as AnimatePresence } from "./index-Ca9-UTcr.js";
import { C as Calendar, R as RefuelBanner, L as LowFuelWarningBanner } from "./RefuelBanner-BxdroH-y.js";
import { T as TimeCircuitsCountdown } from "./TimeCircuitsCountdown-CeRiuzgj.js";
import { c as computeFuelFromExpiry } from "./GasFuelTank-DoETYZVS.js";
import { S as Search } from "./search-t5UlxwV1.js";
import "./useBackup-C-Hf1aJG.js";
import "./download-DNsV216a.js";
/**
...
function ExtensionBanner() {
  ...
  if (typeof window !== "undefined" && window.__COPIE_PASTE_INSTALLED__ === true)
    return null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        boxShadow: "0 0 12px rgba(245, 158, 11, 0.25), inset 0 0 20px rgba(245, 158, 11, 0.04)",
        borderRadius: "0.5rem"
      },
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  children: "Download Expansion Module (.zip)"
                }
              ),
              " ",
              "for 1-click listing."
...
function ListingCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.article,
    {
      ...
      className: `group relative rounded-md overflow-hidden cursor-pointer transition-smooth ${isArchived ? "opacity-60" : ""} ${isOptimistic ? "opacity-70 pointer-events-none" : ""}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-square bg-muted overflow-hidden", children: [
          ...
          isOptimistic && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-black/70 border border-primary/50 font-mono text-[10px] text-primary tracking-widest animate-pulse", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-primary animate-ping inline-block" }),
                "SAVING..."
              ] })
            }
          ),
...
function FieldInput({
  ...
  const counterClass = maxLength && len >= maxLength ? "text-destructive font-semibold" : maxLength && len >= maxLength * 0.9 ? "text-accent" : "text-muted-foreground";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      maxLength && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-xs tabular-nums ${counterClass}`, children: [
        len,
        "/",
        maxLength
      ] })
...
function RadioGroup({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-foreground/80 uppercase tracking-widest block", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", "data-ocid": ocid, children: options.map((o) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: () => onChange(o.value),
        className: `px-3 py-1.5 rounded text-xs font-semibold transition-colors ${value === o.value ? "bg-primary/20 border border-primary/60 text-primary" : "bg-secondary/40 border border-border/50 text-muted-foreground hover:border-primary/40"}`,
        children: o.label
      },
      o.value
    )) })
...
function MercariFields({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-foreground/80 uppercase tracking-widest block", children: [
        "Condition",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive ml-1", children: "*" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: [1, 2, 3, 4, 5].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: () => onChange({ condition: n }),
          className: `flex-1 py-2 rounded text-xs font-bold transition-colors ${fields.condition === n ? "bg-primary/20 border border-primary/60 text-primary" : "bg-secondary/40 border border-border/50 text-muted-foreground hover:border-primary/40"}`,
          "data-ocid": `master_listing_form.mc-condition-${n}.button`,
          children: n
        },
        n
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "1=New … 5=Poor" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FieldSelect,
      {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FieldSelect,
      {
        ...
        onChange: (v) => onChange({ condition_id: v }),
        options: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      RadioGroup,
      {
        ...
        onChange: (v) => onChange({ listing_type: v }),
        options: [
...
function EtsyFields({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      tags.length < 13 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: tags.map((tag, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                type: "button",
                onClick: () => onChange({ tags: tags.filter((_, j) => j !== i) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      RadioGroup,
      {
        ...
        onChange: (v) => onChange({ who_made: v }),
        options: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "label",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground", children: "This is a craft supply or tool" })
        ]
      }
    )
  ] });
}
function OcrPreview({ ocrResult, onAccept, onDismiss }) {
  if (ocrResult.error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4 shrink-0 mt-0.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "OCR Failed:" }),
            " ",
            ocrResult.error,
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-green-400", children: "OCR Scan Complete" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto text-xs text-muted-foreground", children: [
            fields.length,
            " fields found"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: fields.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground uppercase tracking-wide", children: [
            f.label,
            ":",
            " "
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-foreground/90 font-medium", children: [
...
function MasterListingForm({ isOpen, onClose }) {
  ...
  const ocrFileRef = reactExports.useRef(null);
  ...
  const handleDropOnPhoto = (e, targetIdx) => {
    e.preventDefault();
    setIsDragging(false);
  ...
  const handleAcceptOcr = () => {
    ...
    if (ocrResult.description)
      setDescription(ocrResult.description.slice(0, 5e3));
    if (ocrResult.category) setCategory(ocrResult.category);
    setOcrResult(null);
    ue.success("OCR fields applied to form!");
  };
      ...
      },
      {
        onSuccess: () => {
          ue.success("Master listing created!", {
            description: "Use Edit Draft to prepare platform-specific versions."
          });
          resetForm();
          onClose();
        }
  ...
  const titleCounterClass = titleLen >= 200 ? "text-destructive font-semibold" : titleLen >= 180 ? "text-accent" : "text-muted-foreground";
  const descCounterClass = descLen >= 5e3 ? "text-destructive font-semibold" : descLen >= 4500 ? "text-accent" : "text-muted-foreground";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          "dialog",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-0 z-10 flex items-center justify-between px-6 py-4 bg-card border-b border-primary/20 rounded-t-xl", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "One source of truth — prepare platform drafts after" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: isOcrProcessing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-y-auto flex-1 px-6 py-5 space-y-5", children: [
                ocrResult && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  OcrPreview,
                  {
                    ocrResult,
                ...
                isOcrProcessing && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { className: "w-4 h-4 animate-pulse" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Scanning image with Gemini OCR… This may take a moment." })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-foreground/80 uppercase tracking-widest block", children: [
                    "Target Platform",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-normal normal-case", children: "(optional — adds platform-specific fields)" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
                    ...
                    PLATFORMS$2.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        type: "button",
                ...
                selectedPlatform && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-primary/20 bg-primary/5 p-4 space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-primary uppercase tracking-widest mb-3", children: [
                    (_a = PLATFORMS$2.find((p) => p.value === selectedPlatform)) == null ? void 0 : _a.icon,
                    " ",
                    (_b = PLATFORMS$2.find((p) => p.value === selectedPlatform)) == null ? void 0 : _b.label,
                    " ",
                    "Fields"
                  ] }),
                  ...
                  selectedPlatform === "mercari" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    MercariFields,
                    {
                      fields: mcFields,
                  ...
                  selectedPlatform === "ebay" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    EbayFields,
                    {
                      fields: ebFields,
                  ...
                  selectedPlatform === "poshmark" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    PoshmarkFields,
                    {
                      fields: poFields,
                  ...
                  selectedPlatform === "depop" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    DepopFields,
                    {
                      fields: dpFields,
                  ...
                  selectedPlatform === "etsy" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    EtsyFields,
                    {
                      fields: etFields,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground tabular-nums font-mono", children: [
                      photos.length,
                      "/",
                      MAX_PHOTOS
                    ] })
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-5 gap-2", children: [
                      ...
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1 left-1 opacity-0 group-hover:opacity-100 transition-opacity", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GripVertical, { className: "w-3.5 h-3.5 text-foreground/80 drop-shadow" }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "button",
                              {
                                type: "button",
                            ...
                            idx === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1 left-1 px-1 py-0.5 bg-primary/80 rounded text-[9px] font-mono text-primary-foreground", children: "MAIN" })
                          ]
                        },
                        `photo-${idx}-${((_a2 = photos[idx]) == null ? void 0 : _a2.name) ?? idx}`
                      );
                    }),
                    photos.length < MAX_PHOTOS && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        className: `aspect-square rounded-lg border-2 border-dashed cursor-pointer flex flex-col items-center justify-center gap-1 transition-colors select-none ${isDragging ? "border-primary bg-primary/10" : "border-border/50 hover:border-primary/50 hover:bg-primary/5"}`,
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground text-center leading-tight px-1", children: "Add" })
                        ]
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/60", children: "Drag thumbnails to reorder · Click to preview · First photo is main image" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      ref: fileInputRef,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 p-3 rounded-lg bg-primary/[0.08] border border-primary/20 text-xs text-primary/80", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                    ...
                    " to prepare platform-specific versions for each marketplace."
                  ] })
                ] })
              ] }),
    ...
    lightboxIdx !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-4 left-1/2 -translate-x-1/2 z-10 font-mono text-xs text-muted-foreground bg-card/60 rounded px-3 py-1", children: [
            lightboxIdx + 1,
            " / ",
...
function AsciiProgressBar({ percent }) {
  const total = 20;
...
function StepDot({ step, status }) {
  const base = "w-8 h-8 rounded-full border-2 flex items-center justify-center font-mono text-xs font-bold transition-all duration-500";
  const styles = {
    locked: "border-[oklch(0.4_0_0)] text-[oklch(0.4_0_0)]",
    active: "border-[oklch(0.88_0.19_84)] text-[oklch(0.88_0.19_84)]",
    completed: "border-[oklch(0.75_0.18_140)] bg-[oklch(0.75_0.18_140/0.15)] text-[oklch(0.75_0.18_140)]"
  };
  const glowStyles = {
    locked: "",
    active: "shadow-[0_0_8px_oklch(0.88_0.19_84/0.8),0_0_20px_oklch(0.88_0.19_84/0.4)]",
    completed: "shadow-[0_0_6px_oklch(0.75_0.18_140/0.6),0_0_16px_oklch(0.75_0.18_140/0.3)]"
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${base} ${styles[status]} ${glowStyles[status]}`, children: status === "completed" ? "✓" : step });
}
function Cursor() {
...
function Step1({ onComplete, extInstalled }) {
  reactExports.useEffect(() => {
    if (extInstalled) onComplete();
  }, [extInstalled, onComplete]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "onboarding.step1.panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-xs text-[oklch(0.75_0.18_140/0.7)] uppercase tracking-widest", children: [
      "> STATUS: AWAITING EXTENSION INSTALL...",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Cursor, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-[oklch(0.65_0.22_262/0.3)] bg-[oklch(0.65_0.22_262/0.05)] rounded p-4 font-mono text-xs space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[oklch(0.65_0.22_262)] font-bold", children: "> REQUIRED MODULE: Chrome Extension v1.3.0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[oklch(0.7_0_0)]", children: "> The Copie Past-e extension enables autofill" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[oklch(0.7_0_0)]", children: "> injection into marketplace listing forms." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[oklch(0.7_0_0)]", children: "> Manual posting. No auto-submit. You control it." })
    ] }),
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: extInstalled ? "text-[oklch(0.75_0.18_140)]" : "text-[oklch(0.5_0_0)]",
                children: extInstalled ? "[ EXTENSION DETECTED — MODULE ONLINE ]" : "[ EXTENSION NOT DETECTED — INSTALL REQUIRED ]"
              }
            )
          ]
        }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] text-[oklch(0.45_0_0)] text-center", children: "> After install, this step auto-completes. Refresh if needed." })
  ] });
}
function Step2({ onComplete, onOpenNewListing, hasListing }) {
  reactExports.useEffect(() => {
    if (hasListing) onComplete();
  }, [hasListing, onComplete]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "onboarding.step2.panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-xs text-[oklch(0.75_0.18_140/0.7)] uppercase tracking-widest", children: [
      "> OBJECTIVE: CREATE MASTER LISTING RECORD",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Cursor, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-[oklch(0.88_0.19_84/0.3)] bg-[oklch(0.88_0.19_84/0.05)] rounded p-4 font-mono text-xs space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[oklch(0.88_0.19_84)] font-bold", children: "> SYSTEM: MASTER LISTING ARCHITECTURE" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[oklch(0.7_0_0)]", children: "> One master record → 6 platform drafts" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[oklch(0.7_0_0)]", children: "> Facebook • Mercari • eBay • Poshmark • Depop • Etsy" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[oklch(0.7_0_0)]", children: "> Extension autofills forms. You submit manually." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: hasListing ? "text-[oklch(0.75_0.18_140)]" : "text-[oklch(0.5_0_0)]",
              children: hasListing ? "[ LISTING CREATED — RECORD CONFIRMED ]" : "[ NO LISTINGS FOUND — CREATE ONE NOW ]"
            }
          )
        ]
      }
    ),
    !hasListing && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
...
function Step3({ onComplete, onNavigateUpgrade }) {
  const [acknowledged, setAcknowledged] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "onboarding.step3.panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-xs text-[oklch(0.75_0.18_140/0.7)] uppercase tracking-widest", children: [
      "> INITIALIZING TIER MATRIX...",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Cursor, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", children: TIERS.map((tier) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs font-bold text-foreground", children: tier.price })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: tier.features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: acknowledged ? "✓ ACKNOWLEDGED" : "I UNDERSTAND MY TIER"
        }
      )
    ] })
  ] });
...
function OnboardingWizard({
  ...
  const [extInstalled, setExtInstalled] = reactExports.useState(false);
  ...
  const hasListing = ((masterListings == null ? void 0 : masterListings.length) ?? 0) > 0;
  const totalSteps = 3;
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "terminal-header flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "[COPIE PAST-E SYSTEM INITIALIZATION v1.3.0]" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 rounded-full bg-[oklch(0.65_0.25_16/0.7)]" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 rounded-full bg-[oklch(0.88_0.19_84/0.7)]" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 rounded-full bg-[oklch(0.75_0.18_140/0.7)]" })
                ] })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-y-auto flex-1 p-5 space-y-6 terminal-boot", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-[10px] text-[oklch(0.4_0_0)] space-y-0.5 leading-relaxed", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "BIOS v4.0.1 Copyright (C) Copie Past-e Systems Inc." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Checking RAM..... OK" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                    "Loading modules...",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[oklch(0.75_0.18_140)]", children: "SYSTEM ONLINE" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] text-[oklch(0.45_0_0)] uppercase tracking-widest", children: "INITIALIZATION PROGRESS" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[10px] text-[oklch(0.75_0.18_140)]", children: [
                      completedCount,
                      "/",
                      totalSteps,
                      " STEPS"
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(AsciiProgressBar, { percent: progressPercent })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: [1, 2, 3].map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(StepDot, { step: s, status: getStatus(s) }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-1", children: [
                  ...
                  { label: "TIER", step: 3 }
                ].map(({ label, step }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px bg-[oklch(0.65_0.22_262/0.25)]" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-mono text-sm font-bold text-[oklch(0.75_0.18_140)] text-glow-green uppercase tracking-wider", children: [
                ...
                allComplete && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t border-[oklch(0.75_0.18_140/0.3)]", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-xs text-[oklch(0.75_0.18_140)] mb-3 space-y-0.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "> ALL MODULES INITIALIZED" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "> SYSTEM READY — LAUNCHING DASHBOARD..." })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 inline mr-2" }),
                        "LAUNCH COPIE PAST-E"
                      ]
                    }
                  )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border/40 rounded-xl max-w-2xl w-full overflow-hidden max-h-[90vh] flex flex-col", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 border-t border-border/30 flex gap-3 shrink-0 bg-card flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
            ...
            isMobile ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  onClick: () => {
                    const text = [
                      masterListing == null ? void 0 : masterListing.title,
                      (masterListing == null ? void 0 : masterListing.price) ? `Price: ${masterListing.price}` : null
                    ].filter(Boolean).join(" · ");
                    navigator.clipboard.writeText(text).then(() => {
                      ue.success("Listing copied to clipboard");
                    }).catch(() => {
      ...
      (t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            ...
            boxShadow: "0 0 16px oklch(0.88 0.19 84 / 0.25), 0 2px 8px rgba(0,0,0,0.6)",
            minWidth: "300px",
            maxWidth: "380px"
          },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.88 0.19 84)" }, className: "text-sm", children: "⚠" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "oklch(0.75 0 0)", lineHeight: 1.5 }, children: "Extension missing. Install the Expansion Module for 1-click autofill." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
          ...
          step === "pricing" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 p-4 bg-accent/5 border border-accent/20 rounded-lg", children: [
            ...
            selectedPlatforms.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/40 pt-3 space-y-2", children: [
              ...
              selectedPlatforms.map((pid) => {
                const p = PLATFORMS$1.find((x) => x.id === pid);
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("dl", { className: "space-y-1 text-xs", children: [
                ...
                [
                  ...
                  selectedPlatforms.map(
                    (pid) => {
                      var _a2;
                      return (_a2 = PLATFORMS$1.find((p) => p.id === pid)) == null ? void 0 : _a2.emoji;
                    }
                  ).join(" ")
                ],
                [
...
function buildOptimisticListing(tempId, form, platform) {
  return {
    id: tempId,
    ...
    platform: void 0,
    // platform variant not needed for display
    favorited: false,
    pinned: false,
    archivedManually: false,
    userId: null,
    createdAt: BigInt(Date.now()) * 1000000n,
    expirationDate: BigInt(Date.now() + 30 * 24 * 60 * 60 * 1e3) * 1000000n,
...
function mapDepopCondition(val) {
  const map = {
    New: ItemCondition.new_,
...
function CharCounter({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `text-[10px] font-mono mt-1 text-right ${nearLimit ? "text-destructive" : "text-muted-foreground/60"}`,
      children: [
        current,
        "/",
        max
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "label",
    {
      ...
      children: [
        children,
        " ",
        required && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "* Required" })
      ]
    }
  );
}
  ...
  const createMutation = useMutation({
    mutationFn: async () => {
      ...
      const universalPayload = {
        ...
        description: form.description.trim(),
        price: form.price.trim() || void 0,
        platform: Platform__2[platform]
      };
      if (platform === "ebay") {
        universalPayload.category = form.ebayCategory.trim() || void 0;
        universalPayload.condition = mapEbayCondition(form.ebayItemCondition);
        universalPayload.brand = form.ebayBrand.trim() || void 0;
        universalPayload.shippingOption = form.ebayShippingOption;
      } else if (platform === "poshmark") {
        universalPayload.brand = form.poshmarkBrand.trim() || void 0;
        universalPayload.size = form.poshmarkSize.trim() || void 0;
        universalPayload.category = form.poshmarkCategory.trim() || void 0;
      } else if (platform === "depop") {
        universalPayload.brand = form.depopBrand.trim() || void 0;
        universalPayload.condition = mapDepopCondition(form.depopCondition);
        universalPayload.category = form.depopCategory.trim() || void 0;
      } else if (platform === "etsy") {
        universalPayload.materials = form.etsyMaterials.trim() || void 0;
        universalPayload.tags = form.etsyTags.split(",").map((t) => t.trim()).filter(Boolean).slice(0, 13);
        universalPayload.category = form.etsyCategory.trim() || void 0;
      }
      return actor.createListing(universalPayload);
    },
    onMutate: () => {
      if (!platform) return { tempId: null };
      const tempId = nextTempId();
      const optimistic = buildOptimisticListing(tempId, form, platform);
      onOptimisticAdd == null ? void 0 : onOptimisticAdd(optimistic);
      resetForm();
      onClose();
      return { tempId };
    },
    onSuccess: (_, __, context) => {
      queryClient.invalidateQueries({ queryKey: ["listings"] });
      const cfg2 = PLATFORM_CONFIG[platform ?? "facebook"];
      ue.success(`✅ ${cfg2.emoji} ${cfg2.label} listing created!`);
    },
    onError: (err, _, context) => {
      if ((context == null ? void 0 : context.tempId) !== null && (context == null ? void 0 : context.tempId) !== void 0) {
        onOptimisticRollback == null ? void 0 : onOptimisticRollback(context.tempId);
      }
      ue.error(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2.5", children: PLATFORMS.map((p) => {
                      ...
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "button",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground font-mono mt-1 leading-tight", children: pc.tagline }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] text-muted-foreground/50 font-mono mt-1.5 flex items-center gap-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "span",
                              {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-title", children: "Title" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          id: "nlm-title",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CharCounter, { current: form.title.length, max: titleMax })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-desc", children: "Description" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "textarea",
                        {
                          id: "nlm-desc",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CharCounter, { current: form.description.length, max: descMax })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-price", children: "Price" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                    ...
                    platform === "facebook" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: `space-y-3 p-3 border rounded-lg ${cfg == null ? void 0 : cfg.sectionBg} ${cfg == null ? void 0 : cfg.sectionBorder}`,
                        "data-ocid": "new-listing-modal.facebook_section",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                              className: `text-xs font-semibold font-display tracking-wide ${cfg == null ? void 0 : cfg.headingColor}`,
                              children: "📘 Facebook Marketplace Options"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-fb-condition", children: "Condition" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "select",
                              {
                                id: "nlm-fb-condition",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-fb-location", children: "Location" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
                              {
                                id: "nlm-fb-location",
                      ...
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            ...
                            {
                              className: `text-xs font-semibold font-display tracking-wide ${cfg == null ? void 0 : cfg.headingColor}`,
                              children: "🏯 Mercari Options"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-mecari-brand", required: true, children: "Brand" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
                              {
                                id: "nlm-mecari-brand",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-mecari-condition", children: "Condition (1–5 scale)" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "select",
                              {
                                ...
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "1 — New" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "2", children: "2 — Like New" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "3", children: "3 — Good" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "4", children: "4 — Fair" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "5", children: "5 — Poor" })
                                ]
                              }
                            )
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-mecari-shipping", children: "Shipping Type" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "select",
                              {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-mecari-delivery", children: "Delivery Days" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "select",
                              {
                    ...
                    platform === "ebay" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: `space-y-3 p-3 border rounded-lg ${cfg == null ? void 0 : cfg.sectionBg} ${cfg == null ? void 0 : cfg.sectionBorder}`,
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            ...
                            {
                              className: `text-xs font-semibold font-display tracking-wide ${cfg == null ? void 0 : cfg.headingColor}`,
                              children: "🔨 eBay Options"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-ebay-category", children: "Category" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
                              {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-ebay-condition", children: "Item Condition" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "select",
                              {
                                ...
                                children: [
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "For parts or not working", children: "🔧 For parts or not working" })
                                ]
                              }
                            )
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-ebay-brand", children: "Brand" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
                              {
                                id: "nlm-ebay-brand",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-ebay-shipping", children: "Shipping Option" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "select",
                              {
                                id: "nlm-ebay-shipping",
                                value: form.ebayShippingOption,
                                onChange: (e) => set("ebayShippingOption", e.target.value),
                                className: SELECT_CLASS,
                                "data-ocid": "new-listing-modal.ebay_shipping.select",
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "free", children: "🆓 Free Shipping" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "calculated", children: "📐 Calculated Shipping" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "local", children: "📍 Local Pickup Only" })
                                ]
                              }
                            )
                          ] })
                    ...
                    platform === "poshmark" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: `space-y-3 p-3 border rounded-lg ${cfg == null ? void 0 : cfg.sectionBg} ${cfg == null ? void 0 : cfg.sectionBorder}`,
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            ...
                            {
                              className: `text-xs font-semibold font-display tracking-wide ${cfg == null ? void 0 : cfg.headingColor}`,
                              children: "👗 Poshmark Options"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-poshmark-brand", required: true, children: "Brand" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
                              {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-poshmark-size", children: "Size" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
                              {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-poshmark-category", children: "Category" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
                              {
                    ...
                    platform === "depop" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: `space-y-3 p-3 border rounded-lg ${cfg == null ? void 0 : cfg.sectionBg} ${cfg == null ? void 0 : cfg.sectionBorder}`,
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            ...
                            {
                              className: `text-xs font-semibold font-display tracking-wide ${cfg == null ? void 0 : cfg.headingColor}`,
                              children: "🎨 Depop Options"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-depop-brand", children: "Brand" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
                              {
                                id: "nlm-depop-brand",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-depop-condition", children: "Condition" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "select",
                              {
                                ...
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "New", children: "🆕 New" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Like New", children: "✨ Like New" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Good", children: "👍 Good" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Fair", children: "👌 Fair" })
                                ]
                              }
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-depop-category", children: "Category" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
                              {
                    ...
                    platform === "etsy" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: `space-y-3 p-3 border rounded-lg ${cfg == null ? void 0 : cfg.sectionBg} ${cfg == null ? void 0 : cfg.sectionBorder}`,
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            ...
                            {
                              className: `text-xs font-semibold font-display tracking-wide ${cfg == null ? void 0 : cfg.headingColor}`,
                              children: "🛍️ Etsy Options"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-etsy-category", children: "Category" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
                              {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-etsy-materials", children: "Materials" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
                              {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { htmlFor: "nlm-etsy-tags", children: "Tags" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
                              {
                                id: "nlm-etsy-tags",
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-muted-foreground/50 font-mono mt-1", children: [
                              form.etsyTags.split(",").map((t) => t.trim()).filter(Boolean).length,
                              " ",
                              "/ 13 tags"
                            ] })
                          ] })
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2 border-t border-border/40", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          ...
                          children: createMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "span",
                            {
                              className: "flex items-center gap-1.5",
                              "data-ocid": "new-listing-modal.loading_state",
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-spin inline-block w-3 h-3 border-2 border-current border-t-transparent rounded-full" }),
                                "Creating…"
                              ]
                            }
                          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
...
function ListingsGrid({ listings, optimisticIds }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-1.5", "data-ocid": "listings-grid", children: listings.map((listing, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    ListingCard,
    {
      listing,
      index,
      isOptimistic: (optimisticIds == null ? void 0 : optimisticIds.has(listing.id)) ?? false
    },
    listing.id.toString()
  )) });
}
...
function DashboardPage() {
  ...
  const [optimisticListings, addOptimisticListing] = reactExports.useOptimistic(
    allListings,
    (state, newListing) => [newListing, ...state]
  );
  const [optimisticIds, setOptimisticIds] = reactExports.useState(/* @__PURE__ */ new Set());
  function handleOptimisticAdd(listing) {
  ...
  function handleOptimisticRollback(tempId) {
    setOptimisticIds((prev) => {
      const next = new Set(prev);
      next.delete(tempId);
      return next;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-screen-xl mx-auto px-3 sm:px-6 pt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExtensionBanner, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StatusToast, {}),
