import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button, S as Skeleton, R as RefreshCw, g as CircleCheck, T as TriangleAlert, a as ue, af as Clock, Z as Zap, q as Label, n as Input, C as Copy, v as Shield } from "./index-jL7ZpINP.js";
import { D as Database, U as Users, A as AdminLayout } from "./AdminLayout-Wz4fxV6n.js";
...
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-BBX3Rj66.js";
import { T as Textarea } from "./textarea-BeWrVPWq.js";
import { u as useListVersionHistory, a as useCreateVersion, c as useRollbackToVersion, d as useRevertToVersion } from "./useAdminVersions-Be3J7HgB.js";
import { u as useBackupList, a as useVersionSnapshotList, b as useCreateManualBackup, c as useRestoreFromBackup, d as useMarkBackupStable, e as useDeleteBackup, f as useRollbackToStable, g as useExportBackupAsJson, F as FileJson, h as useCreateVersionSnapshot } from "./useBackupDashboard-xwdThOoq.js";
import { P as Plus } from "./plus-DVMeMcLk.js";
import { D as Download } from "./download-CDWdqo78.js";
import { A as Archive } from "./archive-CBZsz1GK.js";
import { R as RotateCcw } from "./rotate-ccw-DK27A3Uv.js";
import { S as Star } from "./star-BIKO8B_9.js";
import { T as Trash2 } from "./trash-2-CvHI816y.js";
import { C as ChevronUp } from "./chevron-up-Dl8n9tFa.js";
import { C as ChevronDown } from "./chevron-down-CajFlzm-.js";
...
function isValidSnapshotImport(obj) {
  if (!obj || typeof obj !== "object") return false;
  const o = obj;
  return typeof o.snapshotId === "string" && typeof o.version === "string" && typeof o.timestamp === "string";
}
function AdminBackupDashboard() {
  ...
  const [snapshotFileTarget, setSnapshotFileTarget] = reactExports.useState(null);
  const [snapshotRestoring, setSnapshotRestoring] = reactExports.useState(false);
  const snapshotFileInputRef = reactExports.useRef(null);
    ...
    reader.onload = (ev) => {
      ...
      try {
        ...
        if (!isValidSnapshotImport(parsed)) {
          ue.error("Invalid snapshot file — missing required fields.", {
            duration: 5e3
          });
          return;
        }
        ...
        ue.error("Invalid snapshot file — could not parse JSON.");
      }
    };
  ...
  async function handleSnapshotFileRestore() {
    ...
    try {
      ...
      if (result.success) {
        setRestoreResult(result);
        ue.success("Restore complete. Snapshot applied.");
      } else {
        ue.error(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          onClick: () => {
            var _a2;
            return (_a2 = snapshotFileInputRef.current) == null ? void 0 : _a2.click();
          },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-card neon-border-blue p-5 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-xs font-bold tracking-widest uppercase text-primary", children: "Restore From Snapshot" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] text-muted-foreground leading-relaxed", children: "Upload a .json snapshot file exported from this admin panel to restore to that saved point. A safety backup is created automatically before restoring." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Archive, { className: "w-6 h-6 text-muted-foreground/40 mx-auto mb-2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs text-muted-foreground", children: "Click to upload a snapshot .json file" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] text-muted-foreground/60 mt-1", children: "Only .json snapshot files are accepted" })
          ]
        }
      ),
      snapshots.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-[10px] text-muted-foreground/70", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: snapshots.length }),
        " existing snapshot",
        snapshots.length === 1 ? "" : "s",
        " available in the Version Snapshots tab"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AlertDialog,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AlertDialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { className: "bg-card border-accent/30 font-body", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display text-sm uppercase tracking-wider text-accent text-glow-yellow", children: "Restore from snapshot file?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-xs text-muted-foreground leading-relaxed space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                "This will restore from snapshot",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground bg-secondary/40 px-1.5 py-0.5 rounded", children: (snapshotFileTarget == null ? void 0 : snapshotFileTarget.snapshotId.slice(0, 8)) ?? "" }),
                " ",
                "created on",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: snapshotFileTarget ? new Date(snapshotFileTarget.timestamp).toLocaleString(
                  "en-US",
                  {
                    month: "short",
                    day: "numeric",
              ...
              ((snapshotFileTarget == null ? void 0 : snapshotFileTarget.userCount) !== void 0 || (snapshotFileTarget == null ? void 0 : snapshotFileTarget.listingCount) !== void 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                "Contains",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-primary font-bold", children: [
                  (snapshotFileTarget == null ? void 0 : snapshotFileTarget.userCount) ?? 0,
                  " users"
                ] }),
                " ",
                "and",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-primary font-bold", children: [
                  (snapshotFileTarget == null ? void 0 : snapshotFileTarget.listingCount) ?? 0,
                  " listings"
                ] }),
                "."
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary/80", children: "A backup will be created before restoring. Continue?" })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function isValidSnapshotFile(obj) {
  if (!obj || typeof obj !== "object") return false;
  const o = obj;
  return typeof o.snapshotId === "string" && typeof o.version === "string" && typeof o.timestamp === "string";
}
function DataSnapshotDashboard() {
  ...
  const [fileRestoreTarget, setFileRestoreTarget] = reactExports.useState(null);
  const [fileRestoring, setFileRestoring] = reactExports.useState(false);
  const fileInputRef = reactExports.useRef(null);
  const [downloadingSnapshot, setDownloadingSnapshot] = reactExports.useState(false);
  ...
  function handleDownloadSnapshot() {
    ...
    if (!latest) {
      ue.error("No snapshots available to download.");
      return;
    }
    setDownloadingSnapshot(true);
    try {
      const createdAtMs = Number(latest.createdAt) / 1e6;
      const exported = {
        schemaVersion: 1,
      ...
      a.click();
      URL.revokeObjectURL(url);
      ue.success("Snapshot downloaded.");
    } catch {
      ue.error("Failed to prepare snapshot file.");
    } finally {
      setDownloadingSnapshot(false);
    }
  }
  function handleSnapshotFileChange(e) {
    var _a2;
    const file = (_a2 = e.target.files) == null ? void 0 : _a2[0];
    if (!file) return;
    e.target.value = "";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-card neon-border-blue p-5 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Archive, { className: "w-4 h-4 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-xs font-bold tracking-widest uppercase text-primary", children: "Restore From Snapshot File" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] text-muted-foreground leading-relaxed", children: "Upload a previously downloaded snapshot .json file to restore to that exact point. A safety backup is created automatically before restoring." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-xs text-muted-foreground leading-relaxed space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                "This will restore from snapshot",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground bg-secondary/40 px-1.5 py-0.5 rounded", children: (fileRestoreTarget == null ? void 0 : fileRestoreTarget.snapshotId.slice(0, 8)) ?? "" }),
                " ",
                "created on",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: fileRestoreTarget ? new Date(fileRestoreTarget.timestamp).toLocaleString(
                  "en-US",
                  {
                    month: "short",
                    day: "numeric",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                ...
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-primary font-bold", children: [
                  (fileRestoreTarget == null ? void 0 : fileRestoreTarget.userCount) ?? 0,
                  " users"
                ] }),
                " ",
                "and",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-primary font-bold", children: [
                  (fileRestoreTarget == null ? void 0 : fileRestoreTarget.listingCount) ?? 0,
                  " listings"
                ] }),
                "."
              ] }),
