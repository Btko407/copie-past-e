import { c as createLucideIcon, d as ue, t as useAdminSettingsContext, j as jsxRuntimeExports, B as Button, g as Copy, r as reactExports, S as Skeleton, X, Z as Zap, w as Link, u as useActor, a as useQueryClient, b as useMutation, e as createActor, k as useQuery, i as useAuth, E as ExternalBlob, x as useParams, o as useNavigate, A as ArrowLeft, s as Input } from "./index-CDYDluDX.js";
import { A as AlertDialog, a as AlertDialogTrigger, b as AlertDialogContent, c as AlertDialogHeader, d as AlertDialogTitle, e as AlertDialogDescription, f as AlertDialogFooter, g as AlertDialogCancel, h as AlertDialogAction } from "./alert-dialog-DtP1GUL4.js";
...
import { u as useExtensionDetection, i as isPlatformSupported } from "./useExtension-DUZbB0Nc.js";
import { A as ALL_PLATFORMS, a as PLATFORM_CONFIG, n as normalizePlatform, P as Pencil } from "./normalizePlatform-BFNN9iI2.js";
...
function buildSmartPostPayload(masterListing, platform, drafts) {
  const draft = drafts == null ? void 0 : drafts.find((d) => normalizePlatform(d.platform) === platform);
  let platformFields = {};
  if (draft == null ? void 0 : draft.platformFields) {
    const pf = draft.platformFields;
    const nested = pf[platform] ?? pf.mecari ?? {};
    if (nested && typeof nested === "object") {
      platformFields = nested;
    }
  }
  const pfTitle = platformFields.title || "";
  const pfDesc = platformFields.description || "";
  const pfPrice = platformFields.price || "";
  return {
    ...
    brand: platformFields.brand || "",
    category: platformFields.category || masterListing.category || "",
    condition: platformFields.condition || "",
    images: Array.isArray(masterListing.photos) ? [] : [],
    // Uint8Array — extension uses URLs; skip
    platformFields
  };
}
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground/90 leading-relaxed", children: [
              ...
              ". Install it to auto-fill listings directly into any marketplace with one click."
            ] }),
...
function SmartPostButtons({
  ...
  const resultListenerRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    function handleResult(e) {
      ...
      const name = (config == null ? void 0 : config.name) ?? platform;
      const filled = Array.isArray(data.filled) ? data.filled : [];
      const failed = Array.isArray(data.failed) ? data.failed : [];
      if (data.ok) {
        ue.success(
          `${(config == null ? void 0 : config.icon) ?? "✅"} Auto-filled ${name}: ${filled.length} field${filled.length === 1 ? "" : "s"} filled`,
          { duration: 4e3 }
        );
      } else {
        ue.error(`Auto-fill ${name} failed`, { duration: 4e3 });
      }
      if (failed.length > 0) {
        ue.warning(
  ...
  function handlePlatformClick(platform) {
    ...
    if (!isInstalled) {
      ...
      const config = PLATFORM_CONFIG[platform];
      ue.success(`${config.icon} Sending to ${config.name} Auto-Fill…`, {
        duration: 2e3
      });
    }
  }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "smart-post-section", children: [
      ...
      isMobile ? (
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", "data-ocid": "smart-post-mobile-disabled", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center font-mono text-[10px] text-muted-foreground leading-relaxed px-1", children: "Install Chrome on desktop to use Smart Post. On mobile, copy your listing details manually." })
        ] })
      ) : (
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", "data-ocid": "smart-post-desktop", children: [
          ...
          ALL_PLATFORMS.map((platform) => {
            ...
            const tooltip = !isInstalled ? "Extension not detected — click to save draft" : isDisabled ? `Update extension to support ${cfg.name}` : `Auto-Fill ${cfg.name}`;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                type: "button",
                ...
                children: [
                  ...
                  isDisabled && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1.5 -right-1.5 px-1 py-0.5 text-[8px] font-display tracking-wider bg-destructive/20 text-destructive rounded-full leading-none border border-destructive/40 whitespace-nowrap", children: "Update Needed" })
                ]
              },
              platform
            );
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SmartPostButtons,
            {
              masterListing: {
                ...
                category: catFields.category || void 0,
                tags: [],
                photos: [],
                platformDrafts: [],
                status: { active: null },
