import { c as createLucideIcon, j as jsxRuntimeExports, d as Layout, aa as Puzzle, r as reactExports, B as Button, Z as Zap, S as Skeleton, I as Input, C as Copy, l as Label, R as RefreshCw, a as ue } from "./index-CfRHchGz.js";
import { B as Badge } from "./badge-BiArleFJ.js";
import { a as useGetMyWebhookToken, b as useGenerateWebhookToken } from "./useExtension-Bn-3GGDy.js";
import { u as useGetMyFbCredentials, a as useSaveFbCredentials } from "./useFbGraph-wBU6j5PW.js";
import { D as Download } from "./download-CunYjLua.js";
import { E as ExternalLink } from "./external-link-uI2Cqa3R.js";
import { E as EyeOff } from "./eye-off-qg-gtukB.js";
import { E as Eye } from "./eye-B0wQbcvS.js";
import { C as Check } from "./check-BlPtDY2d.js";
/**
...
async function downloadExtension(setDownloading) {
  setDownloading(true);
  try {
    const enc = new TextEncoder();
    const fileData = [];
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl sm:text-2xl text-primary text-glow-blue tracking-wider", children: "COPIE PAST-E EXTENSION v1.2.0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs text-muted-foreground", children: "Facebook Marketplace + Mercari autofill · Smart Photo OCR" })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[11px] text-muted-foreground", children: "Chrome only · Requires a free Gemini API key for Smart Photo OCR" })
      ]
    }
  );
}
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-5 border-b border-border/50 bg-primary/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[11px] text-muted-foreground mt-0.5", children: "Chrome Extension · Manifest V3 · v1.2.0" })
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-5 border-b border-border/50", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground font-mono mt-2", children: [
            "Downloads as",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-muted px-1 rounded", children: "copie-paste-extension-v1.2.zip" }),
            " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-2xl mx-auto px-4 py-8 space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-3 pb-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm max-w-md mx-auto leading-relaxed", children: [
          ...
          " or",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Mercari" }),
          " with one click."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DownloadHeroCard, {}),
