import { c as createLucideIcon, r as reactExports, u as useNavigate, L as ListingStatus, j as jsxRuntimeExports, m as motion, S as Skeleton, C as Copy, R as RefreshCw, B as Button, X, a as ue, b as useCheckLowFuelNotification, d as Layout, M as MaintenanceBanner, Z as Zap, I as Input } from "./index-D98vhwYy.js";
import { c as copyText, u as useListingImages, a as useArchiveListing, b as useRestoreListing, d as usePermanentDeleteListing, e as useTogglePin, f as useToggleFavorite, g as useListings, h as useFavoritedListings } from "./copyText-TL3dlyNP.js";
import { u as useGetMySubscription, a as useGetTiers } from "./useTiers-jx-06qXP.js";
import { C as Check } from "./check-y4zrqy6H.js";
...
import { u as useGetPaymentBanner, a as useDismissPaymentBanner, b as useCreateStripePortalSession } from "./useStripePayments-CdgJ-Zc8.js";
import { A as AnimatePresence } from "./index-BaR6lJ-L.js";
import { R as RefuelBanner, L as LowFuelWarningBanner } from "./RefuelBanner-BBiMjgR7.js";
import { T as TimeCircuitsCountdown } from "./TimeCircuitsCountdown-CO4nGGIy.js";
import { c as computeFuelFromExpiry } from "./GasFuelTank-BaLxCnuW.js";
import { S as Search } from "./search-DGxqPbUd.js";
import { P as Plus } from "./plus-DRJ5B-Dl.js";
import "./useBackup-D-5ujEYi.js";
import "./download-c5AGft69.js";
/**
...
function DashboardPage() {
  ...
  const visibleListings = filterBySearch(
    activeTab === "active" ? filterByPlatform(sortedActive) : activeTab === "archived" ? sortedArchived : sortedFavorites
  );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          activeTab === "active" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: `px-3 py-1.5 rounded-md text-xs font-mono font-semibold transition-smooth ${platformFilter === "facebook" ? "bg-blue-600/20 text-blue-300 border border-blue-500/50" : "bg-muted/40 text-muted-foreground border border-border/40 hover:text-foreground hover:bg-muted/60"}`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: `px-3 py-1.5 rounded-md text-xs font-mono font-semibold transition-smooth ${platformFilter === "mecari" ? "bg-pink-600/20 text-pink-300 border border-pink-500/50" : "bg-muted/40 text-muted-foreground border border-border/40 hover:text-foreground hover:bg-muted/60"}`,
