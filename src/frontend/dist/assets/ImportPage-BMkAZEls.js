import { e as React, f as useActor, g as useQueryClient, h as useMutation, E as ExternalBlob, i as createActor, r as reactExports, j as jsxRuntimeExports, m as motion, X, u as useNavigate, k as useAdminSettingsContext, B as Button, l as Label, I as Input, a as ue, d as Layout } from "./index-C4SYi2ho.js";
...
import { I as Image$1 } from "./image-DxgzxRI0.js";
...
function requestExtensionOCR(imageBase64, timeoutMs = 6e3) {
  return new Promise((resolve, reject) => {
    ...
    function handler(event) {
      const d = event.data;
      if ((d == null ? void 0 : d.type) !== "COPIE_PASTE_OCR_RESULT") return;
