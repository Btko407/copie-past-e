import { o as React, b as useActor, d as useQueryClient, e as useMutation, E as ExternalBlob, f as createActor, r as reactExports, j as jsxRuntimeExports, m as motion, X, u as useNavigate, p as useAdminSettingsContext, B as Button, q as Label, n as Input, a as ue, l as Layout } from "./index-jL7ZpINP.js";
...
import { C as ClockAnimation } from "./ClockAnimation-D65Qdvxf.js";
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            prog === 100 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-primary/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-full bg-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { className: "w-3 h-3 text-primary-foreground" }) }) }),
...
function ImportForm({ onCancel }) {
  ...
  const photoPanelRef = reactExports.useRef(null);
  ...
  async function handlePhotoOCR() {
    ...
    requestAnimationFrame(() => {
      var _a;
      (_a = photoPanelRef.current) == null ? void 0 : _a.scrollIntoView({
        behavior: "smooth",
        block: "start"
      });
    });
