import { c as createLucideIcon, j as jsxRuntimeExports, d as Layout, r as reactExports, B as Button, Z as Zap, S as Skeleton, I as Input, C as Copy, l as Label, R as RefreshCw, a as ue } from "./index-C4SYi2ho.js";
import { B as Badge } from "./badge-CytO_Ger.js";
import { a as useGetMyWebhookToken, b as useGenerateWebhookToken } from "./useExtension-DDaDs6u_.js";
import { u as useGetMyFbCredentials, a as useSaveFbCredentials } from "./useFbGraph-DFsBkB59.js";
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-5 border-b border-border/50 bg-primary/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[11px] text-muted-foreground mt-0.5", children: "Chrome Extension · Manifest V3 · v1.1.0" })
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-5 border-b border-border/50", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground font-mono mt-2", children: [
            "Downloads as",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-muted px-1 rounded", children: "copie-paste-extension-v1.1.zip" }),
            " ",
