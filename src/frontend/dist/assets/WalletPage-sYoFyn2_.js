import { f as useActor, p as useQuery, g as useQueryClient, h as useMutation, i as createActor, s as useGetMyGasWallet, t as useGetGasPackages, v as useGetMyGasPurchases, w as useInitiateGasPurchase, x as useSetAutoRenewal, r as reactExports, y as useFailGasPurchase, j as jsxRuntimeExports, d as Layout, m as motion, B as Button, S as Skeleton, F as Fuel, Z as Zap, q as Shield, a as ue, z as useConfirmGasPurchase } from "./index-DkLW0GdO.js";
import { l as loadStripe, E as Elements, u as useStripe, a as useElements, P as PaymentRequestButtonElement, C as CardElement } from "./index-DTf7WBjx.js";
import { c as computeFuelFromExpiry, G as GasFuelTank } from "./GasFuelTank-DVirpA08.js";
import { T as TimeCircuitsCountdown } from "./TimeCircuitsCountdown-BknccBEa.js";
import { C as CarAnimation } from "./CarAnimation-BJ1XfnaF.js";
import { L as LightningAnimation } from "./LightningAnimation-CtwaP-bF.js";
import { B as Badge } from "./badge-Tda6TLdG.js";
import { S as Switch } from "./switch-sq4P8g4a.js";
import { b as useCreateStripePortalSession } from "./useStripePayments-XilLEMTj.js";
import { u as useGetMySubscription } from "./useTiers-B1PTt4S0.js";
import { A as AnimatePresence } from "./index-DGX1a34t.js";
import { E as ExternalLink } from "./external-link-B9PpswDd.js";
import { C as ChevronUp } from "./chevron-up-DWx-dGHe.js";
import { C as ChevronDown } from "./chevron-down-CY2ptGZt.js";
...
function WalletPage() {
  ...
  const { data: packages = [], isLoading: packagesLoading } = useGetGasPackages();
  ...
  const [finalAmount, setFinalAmount] = reactExports.useState(0);
  ...
  async function handleBuyGas() {
    ...
    const matchingPackage = packages.find((p) => {
      ...
      return gTier && (pName.includes(gTier.tierName.toLowerCase()) || pName.includes(gTier.name.toLowerCase()) || p.packageId === selectedGasTierId);
    });
    const pkgId = (matchingPackage == null ? void 0 : matchingPackage.packageId) ?? selectedGasTierId;
    try {
      const result = await initiateGasPurchase.mutateAsync({
        packageId: pkgId
      });
      setPurchaseRecordId(result.purchaseRecordId);
      setFinalAmount(result.finalAmountUSD || ((selectedGasTier == null ? void 0 : selectedGasTier.price) ?? 0));
      setPurchasedGasAmount(result.gasAmount || ((selectedGasTier == null ? void 0 : selectedGasTier.days) ?? 30));
      setClientSecret(result.stripeClientSecret);
      setCheckoutPhase("payment");
    } catch {
      ue.error("Purchase failed. Try again.");
      setCheckoutPhase("idle");
    }
  }
