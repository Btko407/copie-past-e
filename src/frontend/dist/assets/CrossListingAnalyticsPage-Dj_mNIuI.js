import { c as createLucideIcon, ai as commonjsGlobal, ah as getDefaultExportFromCjs, r as reactExports, au as clsx, o as React, av as invariant, b as useActor, i as useQuery, j as jsxRuntimeExports, l as Layout, f as createActor } from "./index-jL7ZpINP.js";
import { T as TrendingUp } from "./trending-up-C7cUv8Kd.js";
import { E as Eye } from "./eye-6syg4eBP.js";
import { D as DollarSign } from "./dollar-sign-CYDF8U4U.js";
import { P as PropTypes } from "./index-GQSqdRWA.js";
/**
...
function getPlatformSummary(listings) {
  const map2 = /* @__PURE__ */ new Map();
  for (const listing of listings) {
    for (const target of listing.targetPlatforms) {
      const name = target.platform;
      if (!map2.has(name)) {
        map2.set(name, { platform: name, views: 0, sales: 0 });
      }
      const entry = map2.get(name);
...
function KpiCard({ label, value, icon, borderColor }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `bg-card p-4 rounded-lg border ${borderColor}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold mt-1 text-foreground", children: value })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "opacity-60", children: icon })
  ] }) });
}
function CrossListingAnalyticsPage() {
  const { actor, isFetching: actorFetching } = useActor(createActor);
  const { data: listings = [], isLoading } = useQuery({
    queryKey: ["universalListings"],
    queryFn: async () => {
      if (!actor) return [];
      return actor.getUserUniversalListings();
    },
    enabled: !!actor && !actorFetching
  });
  const totalViews = listings.reduce(
    (sum, l2) => sum + Number(l2.metrics.totalViews),
    0
  );
  const totalSales = listings.reduce(
    (sum, l2) => sum + Number(l2.metrics.totalSales),
    0
  );
  const totalRevenue = listings.reduce((sum, l2) => {
    const price = l2.price.length > 0 ? Number.parseFloat(l2.price[0] ?? "0") : 0;
    return sum + price * Number(l2.quantitySold);
  }, 0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl font-bold flex items-center gap-2 text-foreground font-display", children: [
        ...
        isEmpty ? (
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-16 w-16 text-muted-foreground/30" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-semibold text-muted-foreground", children: "No cross-listings yet" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground/70 max-w-xs", children: "Create a universal listing from the dashboard to start tracking performance across platforms." })
              ]
            }
          )
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  KpiCard,
                  {
                    ...
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "h-8 w-8 text-primary" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  KpiCard,
                  {
                    ...
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "h-8 w-8 text-accent" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  KpiCard,
                  {
                    ...
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { className: "h-8 w-8 text-green-500" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  KpiCard,
                  {
                    ...
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-8 w-8 text-primary" }),
                    borderColor: "border-primary/20"
                  }
                )
              ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card p-6 rounded-lg border border-border/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-lg mb-4 text-foreground", children: "Sales by Platform" }),
              platformSummary.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: platformSummary, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CartesianGrid,
                  {
                    strokeDasharray: "3 3",
              ...
              ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[300px] flex items-center justify-center text-muted-foreground/50 text-sm", children: "No platform data" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card p-6 rounded-lg border border-border/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-lg mb-4 text-foreground", children: "View Distribution" }),
              platformSummary.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Pie,
                  {
                    ...
                    children: platformSummary.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Cell,
                      {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/40 bg-secondary/50", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left font-semibold text-foreground", children: "Platform" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-right font-semibold text-foreground", children: "Views" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-right font-semibold text-foreground", children: "Sales" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-right font-semibold text-foreground", children: "Conversion" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: platformSummary.map((platform, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "tr",
                  {
                    className: "border-b border-border/20 hover:bg-secondary/20 transition-colors",
                    "data-ocid": `cross-listing-analytics.row.${i + 1}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-semibold text-foreground capitalize", children: platform.platform }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right text-muted-foreground", children: platform.views.toLocaleString() }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right text-muted-foreground", children: platform.sales }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right text-muted-foreground", children: platform.views > 0 ? `${(platform.sales / platform.views * 100).toFixed(2)}%` : "0%" })
                    ]
                  },
                  platform.platform
                )) })
