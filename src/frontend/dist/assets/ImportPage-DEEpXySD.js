import { e as React, f as useActor, g as useQueryClient, h as useMutation, E as ExternalBlob, i as createActor, r as reactExports, j as jsxRuntimeExports, m as motion, X, u as useNavigate, k as useAdminSettingsContext, B as Button, l as Label, I as Input, a as ue, d as Layout } from "./index-C4SV0eZt.js";
...
import { I as Image$1 } from "./image-T29oXYiB.js";
import { C as CarAnimation } from "./CarAnimation-CVziKtwN.js";
import { C as ClockAnimation } from "./ClockAnimation-V-fjzBiz.js";
...
function ocrViaExtension(imageBase64) {
  return new Promise((resolve) => {
    ...
    function handler(event) {
      var _a, _b;
      if (((_a = event.data) == null ? void 0 : _a.type) !== "COPIE_PASTE_OCR_RESPONSE")
        return;
      if (((_b = event.data) == null ? void 0 : _b.requestId) !== requestId)
        return;
...
function usePhotoOCR() {
  ...
  const extOcrRef = reactExports.useRef(extHasOcrGlobal);
  reactExports.useEffect(() => {
    function handleMessage(event) {
      var _a, _b;
      if (((_a = event.data) == null ? void 0 : _a.type) === "COPIE_PASTE_EXT_PRESENT" && ((_b = event.data) == null ? void 0 : _b.hasOcr)) {
  ...
  async function extractFromImage(file) {
    ...
    try {
      ...
      if (extOcrRef.current || extHasOcrGlobal) {
        ...
        const result2 = normaliseOcrFields(response.data);
        if (!result2) {
          return fail(
