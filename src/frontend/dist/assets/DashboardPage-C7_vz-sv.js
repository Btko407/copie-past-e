import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, X, L as ListingStatus__2, m as motion, B as Button, u as useActor, a as useQueryClient, b as useMutation, d as ue, e as createActor, C as CircleCheck, f as useDevice, T as TriangleAlert, g as Copy, h as useExtensionStatus, Z as Zap, i as useAuth, k as useQuery, P as Platform__1, l as Platform__2, n as ListingStatus, I as ItemCondition, o as useNavigate, p as useCheckLowFuelNotification, q as Layout, M as MaintenanceBanner, s as Input, S as Skeleton } from "./index-CDYDluDX.js";
import { A as ALL_PLATFORMS, P as Pencil, n as normalizePlatform, a as PLATFORM_CONFIG$1 } from "./normalizePlatform-BFNN9iI2.js";
import { S as Star } from "./star-D0vL9Z1b.js";
import { P as Plus } from "./plus-BzuK47jx.js";
import { u as usePhotoOCR } from "./usePhotoOCR-CSf6wnBE.js";
import { L as LoaderCircle } from "./loader-circle-BkTHt6EF.js";
import { U as Upload } from "./upload-DKhZOaz_.js";
import { T as Tag } from "./tag-DjQRenHT.js";
import { u as useGetPaymentBanner, a as useDismissPaymentBanner, b as useCreateStripePortalSession } from "./useStripePayments-CjKiG-SB.js";
import { A as AnimatePresence } from "./index-XRn9Sjl6.js";
import { E as ExternalLink } from "./external-link-Bt1eODa_.js";
import { C as Calendar, R as RefuelBanner, L as LowFuelWarningBanner } from "./RefuelBanner-CO5Cl2H9.js";
import { T as TimeCircuitsCountdown } from "./TimeCircuitsCountdown-CE8BHW6L.js";
import { T as Trash2 } from "./trash-2-B9mOI9ri.js";
import { u as useGetMySubscription, a as useGetTiers } from "./useTiers-7_nHBRgX.js";
import { c as computeFuelFromExpiry } from "./GasFuelTank-CNAyv_kS.js";
import { S as Search } from "./search-dOANVp4w.js";
import "./useBackup-l6MP3E0m.js";
import "./download-DEXd4YsB.js";
/**
...
const DEFAULT_EXTENSION_VERSION = "1.3.1";
function getLocalExtensionDownloadUrl(version = DEFAULT_EXTENSION_VERSION) {
  return `/copie-paste-extension-v${version}.zip`;
}
const EXTENSION_DOWNLOAD_URL = getLocalExtensionDownloadUrl();
...
function getDraftSummaries(ml) {
  return ml.platformDrafts.map((d) => {
    const platform = normalizePlatform(d.platform);
    if (!platform) return null;
    const statusRaw = typeof d.status === "string" ? d.status : typeof d.status === "object" && d.status !== null ? Object.keys(d.status)[0] ?? "" : "";
    const status = ["saved", "preparing", "ready", "posted"].includes(statusRaw) ? statusRaw : "unsaved";
    return {
      draftId: d.draftId,
      platform,
      status,
...
function DraftMenu({ draftMap, onEditDraft, onClose }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-full right-0 mb-1 z-50 min-w-[170px] bg-card border border-border/60 rounded-lg shadow-xl overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2.5 py-1.5 border-b border-border/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-display font-bold text-muted-foreground uppercase tracking-widest", children: "Platform Drafts" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-1 max-h-52 overflow-y-auto", children: ALL_PLATFORMS.map((platform) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            existing && existing.status !== "unsaved" && existing.status !== "posted" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto font-mono text-[9px] text-muted-foreground", children: [
...
function PlatformBadges({ drafts }) {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
          ...
          children: [
            ...
            d.status === "posted" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-400", children: "✓" })
          ]
        },
        d.draftId
      );
...
function MasterListingCard({
  ...
  const thumbnailUrl = (() => {
    var _a;
    if (imageError || !((_a = listing.photos) == null ? void 0 : _a.length)) return null;
    try {
      const bytes = listing.photos[0];
      if (!(bytes == null ? void 0 : bytes.length)) return null;
  ...
  const updatedAtMs = nsToMs$1(listing.updatedAt);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.article,
    {
      ...
      className: `group relative rounded-md overflow-hidden border border-border/40 bg-card transition-smooth hover:border-primary/40 hover:shadow-[0_0_12px_oklch(0.65_0.22_262_/_0.15)] ${isArchived ? "opacity-60" : ""}`,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-square bg-muted overflow-hidden", children: [
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex items-center justify-center retro-grid opacity-30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl", children: "📋" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black/40 via-transparent to-black/60 pointer-events-none" }),
          isFavorited && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1.5 right-1.5 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Star,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1.5 left-1.5 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `px-1.5 py-0.5 rounded text-[9px] font-mono font-bold ${statusBadge.cls}`,
              children: statusBadge.label
            }
          ) }),
          draftCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1.5 left-1.5 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-1.5 py-0.5 rounded text-[9px] font-mono bg-primary/80 text-primary-foreground", children: [
            draftCount,
            "/6"
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-2 pt-1.5 pb-2 bg-card space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 flex-wrap", children: [
            listing.price && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[10px] text-accent leading-none", children: [
              "$",
              listing.price
            ] }),
            listing.category && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[9px] text-muted-foreground leading-none", children: [
              "· ",
              listing.category
            ] })
          ] }),
          drafts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(PlatformBadges, { drafts }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-1 pt-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[9px] text-muted-foreground/70 truncate leading-none", children: relativeTime }),
            onEditDraft && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  size: "sm",
  ...
  return useMutation({
    mutationFn: async (args) => {
      ...
      const result = await actor.createMasterListing({
        ...
        price: args.price !== null ? args.price : void 0,
        category: args.category !== null ? args.category : void 0,
        tags: args.tags,
        photos: args.photos,
...
function MasterListingForm({ isOpen, onClose }) {
  ...
  const requestIdRef = reactExports.useRef(null);
...
const platformEnumMap = {
  facebook: "facebook",
  mercari: "mecari",
  // backend Candid uses 'mecari'; frontend key is 'mercari'
  ebay: "ebay",
  poshmark: "poshmark",
  depop: "depop",
  etsy: "etsy"
    ...
    saveDraft.mutate(
      {
        ...
        input: (() => {
          switch (platform) {
            ...
            case "mercari":
              return { platform: "mercari", fields: mcFields };
            case "ebay":
...
function filterMasterByDateRange(listings, filter) {
...
function SkeletonGrid() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-1.5", "data-ocid": "listings-skeleton", children: Array.from({ length: 9 }, (_, i) => `sk-${i}`).map((key) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-2 pt-1.5 pb-2 bg-card space-y-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-2 w-1/2 rounded" })
    ] })
  ] }, key)) });
}
function EmptyState({ tab, onNewListing }) {
  var _a, _b;
  const isPlatform = ALL_PLATFORMS.includes(tab);
  const platformName = isPlatform ? ((_a = PLATFORM_CONFIG$1[tab]) == null ? void 0 : _a.name) ?? tab : tab;
  const config = {
    all: {
      icon: "📋",
  ...
  const activeConfig = config[tab] ?? {
    icon: ((_b = PLATFORM_CONFIG$1[tab]) == null ? void 0 : _b.icon) ?? "📋",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl mb-4", children: activeConfig.icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base font-bold text-foreground text-glow-blue mb-2", children: activeConfig.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs leading-relaxed mb-6", children: activeConfig.desc }),
        activeConfig.showCta && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
...
function MasterListingsGrid({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-1.5", "data-ocid": "master-listings-grid", children: masterListings.map((ml, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    MasterListingCard,
    {
      listing: ml,
      index,
...
const MASTER_TABS = [
  ...
  { key: "facebook", label: "Facebook", icon: PLATFORM_CONFIG$1.facebook.icon },
  { key: "mercari", label: "Mercari", icon: PLATFORM_CONFIG$1.mercari.icon },
  { key: "ebay", label: "eBay", icon: PLATFORM_CONFIG$1.ebay.icon },
  { key: "poshmark", label: "Poshmark", icon: PLATFORM_CONFIG$1.poshmark.icon },
  { key: "depop", label: "Depop", icon: PLATFORM_CONFIG$1.depop.icon },
  { key: "etsy", label: "Etsy", icon: PLATFORM_CONFIG$1.etsy.icon },
  { key: "archived", label: "Archived", icon: "🗃" },
  { key: "favorites", label: "Favorites", icon: "⭐" }
];
function MasterTabBar({ active, counts, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "overflow-x-auto whitespace-nowrap scrollbar-none pb-1",
      "data-ocid": "master-tab-bar",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex gap-1", children: MASTER_TABS.map(({ key, label, icon }) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `inline-flex items-center gap-1 px-2.5 py-1.5 rounded-md text-[11px] font-mono font-semibold transition-smooth shrink-0 ${isActive ? "bg-primary/20 text-primary border border-primary/50" : "bg-muted/40 text-muted-foreground border border-border/40 hover:text-foreground hover:bg-muted/60"}`,
            ...
            children: [
              ...
              count > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `px-1 py-0.5 rounded text-[9px] font-mono leading-none ${isActive ? "bg-primary/30 text-primary" : "bg-muted text-muted-foreground"}`,
                  children: count
                }
              )
            ]
...
function DashboardPage() {
  ...
  function handleOptimisticAdd(_listing) {
  }
  function handleOptimisticRollback(_tempId) {
  }
  const now = Date.now();
  ...
  const filteredMasterListings = reactExports.useMemo(() => {
    ...
    if (activeTab === "archived") {
      ...
      const platformTab = activeTab;
      items = items.filter(
        (ml) => ml.platformDrafts.some(
    ...
    if (q) {
      items = items.filter(
        (ml) => ml.title.toLowerCase().includes(q) || ml.description.toLowerCase().includes(q) || (ml.category ?? "").toLowerCase().includes(q)
      );
    }
  ...
  const tabCounts = reactExports.useMemo(() => {
    ...
    for (const p of ALL_PLATFORMS) {
      counts[p] = masterListings.filter(
        (ml) => ml.status !== ListingStatus__2.archived && ml.platformDrafts.some((d) => normalizePlatform(d.platform) === p)
      ).length;
    }
    return counts;
  }, [masterListings]);
  const daysUntilDeletion = isSubscriptionExpired && expirationMs !== null ? Math.max(
    0,
    Math.floor(
      (expirationMs + 30 * 24 * 60 * 60 * 1e3 - now) / (1e3 * 60 * 60 * 24)
    )
  ) : null;
  const showRefuelBanner = !bannerDismissed && isSubscriptionExpired && tabCounts.archived > 0 && daysUntilDeletion !== null;
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          activeTab !== "archived" && activeTab !== "favorites" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 flex-wrap items-center mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "master-listings-section", children: masterListingsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonGrid, {}) : filteredMasterListings.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            EmptyState,
            {
              tab: activeTab,
