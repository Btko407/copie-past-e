  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "glow-md": "0 0 12px rgba(0, 212, 255, 0.4), 0 0 24px rgba(0, 212, 255, 0.2)",
        "glow-lg": "0 0 20px rgba(0, 212, 255, 0.5), 0 0 40px rgba(0, 212, 255, 0.25)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "circuit-pulse": {
          "0%, 100%": { opacity: "0.5", boxShadow: "0 0 8px currentColor" },
      ...
      animation: {
        ...
        lightning: "lightning 0.6s ease-in-out",
